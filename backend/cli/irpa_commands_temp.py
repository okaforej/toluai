...
def register_irpa_commands(app):
    ...
    app.cli.add_command(init_irpa_reference_data)
    app.cli.add_command(setup_irpa_permissions)
    app.cli.add_command(create_irpa_admin)
    app.cli.add_command(init_irpa_system)